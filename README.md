...
### How much BTM can exist? – So many puppies!
...
### How to get BTM ? – To the moon!
BTM uses a simplified variant of the scrypt key derivation function as its proof of work with a target time of one minute per block and difficulty readjustment after every block. The block rewards are fixed and halve every 100,000 blocks. Starting with the 600,000th block, a permanent reward of 10,000 BTN per block will be paid. 
...
### Wow plz make Bitmillion-cli/bitmillion-qt
...
Run with the -testnet option to run with "play bitmillion" on the test network, if you
...
Bitmillion Core is a multithreaded application, and deadlocks or other multithreading bugs
